...
public class FileWordCount {
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        File inputFile = new File(userHome + "/source/training/week2/day34/wordCountInput.txt");
        ...
        File outputFile = new File(userHome + "/source/training/week2/day34/wordCountOutput.txt");
